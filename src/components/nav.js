    ...
    render() {
        ...
        <nav>
            <ul class="flex">
                ...
                <li><a href="/News" class="block py-3 px-4 text-white text-xl hover:text-orange-500 hover:font-semibold">News</a></li>
                <li><a href="/About" class="block py-3 px-4 text-white text-xl hover:text-orange-500 hover:font-semibold">About</a></li>
